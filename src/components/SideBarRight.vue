  ...
  <v-navigation-drawer app color="white" right width="290">
      <v-list subheader two-line class="mt-1">
          <v-list-item>
              ...
              <v-list-item-content>
                  ...
                  <v-list-item-title>Renaldy Darmawan</v-list-item-title>
              </v-list-item-content>
              <v-list-item-action>
      ...
      <v-list subheader two-line class="mt-1">
          <v-list-item>
              ...
              <v-list-item-action class="caption">Rp 15000</v-list-item-action>
          </v-list-item>
      </v-list>
      <v-list subheader two-line class="mt-1">
          <v-list-item>
              ...
              <v-list-item-action class="caption">Rp 24000</v-list-item-action>
          </v-list-item>
      </v-list>
      <v-list subheader two-line class="mt-1">
          <v-list-item>
              ...
              <v-list-item-action class="caption">Rp 13000</v-list-item-action>
          </v-list-item>
      </v-list>
      <v-toolbar color="rgba(0,0,0,0)" flat>
          <strong>Subtotal</strong><v-spacer></v-spacer><strong>Rp 52000</strong>
      </v-toolbar>
      <v-toolbar color="rgba(0,0,0,0)" flat class="mt-n6">
          <span>PPN(10%)</span><v-spacer></v-spacer><span>Rp10000</span>
      </v-toolbar>
      <v-divider class="mx-4"></v-divider>
      <v-toolbar color="rgba(0,0,0,0)" flat>
          <strong>Total</strong><v-spacer></v-spacer><strong>Rp 5200</strong>
      </v-toolbar>
      ...
      <div class="mx-3 mt-2">
          <v-btn color="#704232" block dark class="widthoutupercase">Print Tagihan</v-btn>
      </div>
  </v-navigation-drawer>
</template>
